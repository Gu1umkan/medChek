...
public class Main {
    public static void main(String[] args) {
        ...
        DepartmentService departmentService = new DepartmentServiceImpl(new DepartmentDaoImpl(database));
        DoctorService doctorService = new DoctorServiceImpl(new DoctorDaoImpl(database));
        PatientService patientService = new PatientServiceImpl(new PatientDaoImpl(database));
        outLoop:
        while (true) {
            menu();
            try {
                switch (scanner.nextInt()) {
                    ...
                    case 24 -> {
                        ...
                        System.out.println("\n" + patientService.getPatientByAge());
                    }
                    case 25 -> {
